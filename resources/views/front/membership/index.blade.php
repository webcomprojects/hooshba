                    ...
                    <form method="POST" action="{{ route('front.membership.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-login">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-16-semibold pb-2">نام <span
                                                class="gfield_required">*</span></label>
                                        <input type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-16-semibold pb-2">نام خانوادگی <span
                                                class="gfield_required">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-16-semibold pb-2">کدملی <span
                                                class="gfield_required">*</span></label>
                                        <input type="text"
                                            class="form-control   @error('national_id') is-invalid @enderror"
                                            name="national_id" value="{{ old('national_id') }}" required=""
                                            autofocus="" placeholder="کدملی  ">
                                        @error('national_id')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="referral_name"
                                            class="form-control  @error('referral_name') is-invalid @enderror"
                                            placeholder="نام معرف" value="{{ old('referral_name') }}">
                                        @error('referral_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-16-semibold pb-2">تاریخ تولد <span
                                                class="gfield_required">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-16-semibold pb-2">شماره شناسنامه <span
                                                class="gfield_required">*</span></label>
                                        <input type="text"
                                            ...
                                            required="" autofocus="" placeholder="شماره شناسنامه  ">
                                        ...
                                        @foreach ($educationHistories as $index => $history)
                                            <div class="Educational_background_item">
                                                ...
                                                @if ($index != 0)
                                                    ...
                                                    <button
                                                        class="remove_btn_Educational_background_item btn btn-no-arrow"><i
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old("education_histories.$index.degree") }}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('education_histories.0.degree') }}"
                                                            placeholder="مدرک تحصیلی">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('education_histories.0.university') }}"
                                                            placeholder="نام موسسه">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('education_histories.0.field_of_study') }}"
                                                            placeholder="نام رشته">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('education_histories.0.specialization') }}"
                                                            placeholder="نام گرایش">
                            ...
                            <div class="row mt-5">
                                ...
                                <label class="text-16-semibold pb-2">(۳ تجربه آخر) <span
                                        class="gfield_required">*</span></label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old("job_histories.{$index}.company") }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old("job_histories.{$index}.position") }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old("job_histories.{$index}.start_year") }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old("job_histories.{$index}.end_year") }}"
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="job_histories[0][company]"
                                                            value="{{ old('job_histories.0.company') }}" required
                                                            placeholder="نام موسسه">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="job_histories[0][position]"
                                                            value="{{ old('job_histories.0.position') }}" required
                                                            placeholder="سمت">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="job_histories[0][start_year]"
                                                            value="{{ old('job_histories.0.start_year') }}" required
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="job_histories[0][end_year]"
                                                            value="{{ old('job_histories.0.end_year') }}"
                                                            placeholder="سال پایان">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="address2" value="{{ old('address2') }}"autofocus=""
                                            placeholder="آدرس 2  ">
                                        @error('address2')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-16-semibold pb-2">ایمیل <span
                                                class="gfield_required">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-16-semibold pb-2">تلفن همراه <span
                                                class="gfield_required">*</span></label>
                                                    ...
                                                    <div class="col-md-11">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="experience_ai[{{ $index }}]"
                                                                value="{{ $exp }}" placeholder="شرح تجربیات">
                                                ...
                                                <div class="col-md-11">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="experience_ai[]" value="" autofocus=""
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-16-semibold pb-2">فایل رزومه <span
                                                    class="gfield_required">*</span></label>
                                            <input type="file"
                                                class="form-control   @error('resume_file') is-invalid @enderror"
                                                name="resume_file" value="{{ old('resume_file') }}" required=""
                                                autofocus="">
                                            @error('resume_file')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-16-semibold pb-2"> تصویر آخرین مدرک تحصیلی <span
                                                    class="gfield_required">*</span></label>
                                            <input type="file"
                                                class="form-control   @error('degree_certificate_image') is-invalid @enderror"
                                                name="degree_certificate_image"
                                                value="{{ old('degree_certificate_image') }}" required=""
                                                autofocus="">
                            ...
                            <div class="box-forgot-pass">
                                <label>
                                    <input type="checkbox" class="cb-remember" name="final_approval" value="1"
                                        required {{ old('final_approval') == 1 ? 'checked' : '' }}> <span>
