                ...
                <div class="portlet-body edit-form">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 m-auto m-b-30">
                            ...
                            <form class="information" action="{{ route('back.settings.footerlinks.store') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group round">
                                                ...
                                                <select  name="link_group_id" class="form-control ">
                                                    <option value="0"> گروه اول</option>
                                                    <option value="1"> گروه دوم</option>
                                                    <option value="2"> گروه سوم</option>
