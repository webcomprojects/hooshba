                ...
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 m-auto m-b-30">
                            <form action="{{ route('back.pages.update', $page) }}" role="form" method="POST">
                                @csrf
                                @method('put')
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group curve">
                                            <label> عنوان </label>
                                            <input id="title" name="title" type="text" class="form-control" value="{{ old('title') ? old('title') : $page->title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group curve">
                                            <label> url </label>
                                            <input id="address" name="slug" type="text" class="form-control" value="{{ old('slug') ? old('slug') : $page->slug }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="content" class="form-control" rows="3" name="content">{!! old('content') ? old('content') : $page->content !!}</textarea>
                                        </div>
                                    </div>
