...
@section('content')
                                        ...
                                        <div class="col-10">
                                            <div class="form-group curve">
                                                <input name="name" type="text" class="form-control"
                                                    value="{{ old('name') }}" placeholder="افزودن منو جدید..."
                                                    autofocus>
                                            </div>
                                        </div>
    ...
    <div id="edit-menu-modal" class="modal fade" role="dialog" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="border-top: unset">
                    <form action="#" id="edit-menu-form" class="row" method="post">
                        @csrf
                        @method('put')
    ...
    @include('back.partials.delete-modal', [
        'text_body' => ' با حذف منو،دیگر قادر به بازیابی آن نخواهید بود، منوهای فرزد هم حذف می شوند .',
    ])
...
@push('scripts')
    <script src="{{ asset('assets/back/js/pages/pages/menus/nestable.js') }}"></script>
@endpush
