            ...
            <div class="portlet box shadow">
                ...
                <div class="mb-2 datatable-actions collapse " style="">
                    <div class="d-flex align-items-center">
                        ...
                        <button class="btn btn-danger multiple-delete-modal" data-action="{{route('back.posts.multipleDestroy')}}" type="button" data-bs-toggle="modal" data-bs-target="#multiple-delete-modal">خذف همه</button>
                    </div>
                </div>
                                ...
                                @foreach($members as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('back.posts.edit',$item)}}" class="btn btn-info">ویرایش<div class="paper-ripple"><div class="paper-ripple__background" style="opacity: 0.00256;"></div><div class="paper-ripple__waves"></div></div></a>

                                                <button data-bs-toggle="modal" data-bs-target="#delete-modal" data-action="{{route('back.posts.destroy',$item)}}" class="btn btn-danger delete-modal">حذف<div class="paper-ripple"><div class="paper-ripple__background"></div><div class="paper-ripple__waves"></div></div></button>
...
@include('back.partials.delete-modal',['text_body'=>'با حذف مقاله،دیگر قادر به بازیابی آن نخواهید بود' ])
@include('back.partials.multiple-delete-modal',['text_body'=>'با حذف مقالات،دیگر قادر به بازیابی آنها نخواهید بود.'])
