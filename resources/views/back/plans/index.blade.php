                ...
                <div class="portlet-body edit-form">
                    <div class="row">
                        <div class="col-lg-10 col-md-10 m-auto m-b-30">
                            ...
                            <form action="{{ route('back.about-us.plans.store') }}" role="form" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group curve">
                                            <label> عنوان </label>
                                            <input name="plans_title" type="text" class="form-control"
                                                value="{{ option('plans_title') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group curve">
                                            ...
                                            <textarea name="plans_shortContent" rows="4" class="form-control">{!! option('plans_shortContent') !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div id="goals_items">
                                        @php
                                            $corporate_experience_ai = old('morePlans', json_decode(option('morePlans'), true) ?? []);
                                        @endphp
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="morePlans[{{ $index }}][title]"
                                                                    value="{{ old("morePlans.$index.title", $exp['title'] ?? '') }}"
                                                                    placeholder="">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="text-16-semibold pb-2"> مدت زمان </label>
                                                                <input type="text" class="form-control"
                                                                    name="morePlans[{{ $index }}][time]"
                                                                    value="{{ old("morePlans.$index.time", $exp['time'] ?? '') }}"
                                                                    placeholder="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="morePlans[{{ $index }}][description]" class="form-control" rows="3">{!! old("morePlans.$index.description", $exp['description'] ?? '') !!}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="goals_item">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="text-16-semibold pb-2"> عنوان </label>
                                                            <input type="text" class="form-control" name="morePlans[0][title]" value="" placeholder="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="text-16-semibold pb-2"> توضیحات </label>
                                                            <textarea name="morePlans[0][description]" class="form-control" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
