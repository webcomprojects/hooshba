            ...
            <div class="portlet box shadow">
                ...
                <div class="mb-2 datatable-actions collapse " style="">
                    <div class="d-flex align-items-center">
                        ...
                        <button class="btn btn-danger multiple-delete-modal" data-action="{{route('back.regions.multipleDestroy')}}" type="button" data-bs-toggle="modal" data-bs-target="#multiple-delete-modal">خذف همه</button>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th> عنوان</th>
                                <th class="text-center"> تعداد استان ها</th>
                            ...
                            @if(count($regions))
                                @foreach($regions as $item)
                                    <tr>
                                        ...
                                        <td>{{$item->name}}</td>
                                        <td class="text-center">{{ @$item->provinces->count() ?: 0}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('back.regions.edit',$item)}}" class="btn btn-info">ویرایش<div class="paper-ripple"><div class="paper-ripple__background" style="opacity: 0.00256;"></div><div class="paper-ripple__waves"></div></div></a>

                                                <button data-bs-toggle="modal" data-bs-target="#delete-modal" data-action="{{route('back.regions.destroy',$item)}}" class="btn btn-danger delete-modal">حذف<div class="paper-ripple"><div class="paper-ripple__background"></div><div class="paper-ripple__waves"></div></div></button>
...
@include('back.partials.delete-modal',['text_body'=>'با حذف منطقه،دیگر قادر به بازیابی آن نخواهید بود' ])
@include('back.partials.multiple-delete-modal',['text_body'=>'با حذف مناطق،دیگر قادر به بازیابی آنها نخواهید بود.'])
